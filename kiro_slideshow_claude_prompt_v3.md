...
- Path-audience mode → "gold"
- Path-gap mode      → "diamond"
- "platinum"  → reserved for special/milestone posts, not the weekly rotation
- "iridescent" → reserved, do not use (future marketing reveal)
